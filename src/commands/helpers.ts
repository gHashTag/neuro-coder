  ...
  try {
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: `You are a professional translator. Always answer with letters, without using numbers.Translate the following text to ${targetLang}. Preserve the original meaning and tone as much as possible. ${
            targetLang === "ru" && "In Cyrillic all words"
          }`,
        },
        {
          role: "user",
